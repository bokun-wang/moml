...
class MOMLV2():
    ...
    def inner_loop(self, tr_X, tr_y, val_X, val_y, task_id):
        ...
        temp_weights = [((1 - self.beta) * per_w + self.beta * temp_w + self.beta * (self.N_tasks / self.B_tasks) * (
        ...
        for iteration in range(1, num_iterations + 1):
            ...
            for id in range(self.N_tasks):
                if id in sampled_ids:
                    ...
                    meta_loss += self.inner_loop(tr_X, tr_y, val_X, val_y, task_id=id) / self.B_tasks
                else:
